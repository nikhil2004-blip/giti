...
- Placeholders like `<branch>` are allowed in AI suggestions.
- Potentially risky shell patterns are shown with a warning message instead of hard-failing the suggestion.
